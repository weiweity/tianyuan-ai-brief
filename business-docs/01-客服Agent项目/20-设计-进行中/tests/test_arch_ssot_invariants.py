...
def test_current_portfolio_dashboard_keeps_architecture_redlines() -> None:
    ...
    assert footer.startswith("*G0 责任与证据台账 v3.86 · 2026-09-09")
...
def test_arch_board_tabs_a11y_fit_mapping_and_offline() -> None:
    ...
    _assert_same_line(t, "当前推进项", "第 4 关代码开发", "G0=PASS", "Ddev=PASS", "DEV-M1 产品实施与退出证据已完成", "实施已批准的桌面合成接入 D1–D5", "待单独授权")
