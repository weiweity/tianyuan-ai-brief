...
- [A2b-1 承接内容摘要](03-A2b-1承接内容摘要.md)：最终摘要候选及纯合成验证；完整 A2b 与产品消费仍待完成。

- [A2b-2 承接候选范围核对](04-A2b-2承接候选范围核对.md)：内部断言核对实际候选、来源事实及有效承接；存储/发布接线仍待后续 PR。

- [A2b-3 承接存储完整性](05-A2b-3承接存储完整性.md)：三表实际行、条目版本、租户与有效承接绑定；完整消费者和产品接线尚待完成。
